...
import {
  ...
  BadRequestError,
  NotFoundError,
} from "../../../shared/utils/helper/customError";
import {
  hashPassword,
  comparePasswords,
} from "../../../shared/utils/helper/encryptPassword";
import { createJWT, verifyJWT } from "../../../shared/utils/helper/jwt";
import { referralCode } from "../../../shared/utils/helper/generateReferralCode";
import {
  ConversionRate,
  ReferralPoints,
